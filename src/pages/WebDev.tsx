...
const categories = ["All", "Frontend", "Backend", "Databases", "Cloud", "DevOps", "Full-Stack"];
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                {filteredPosts.map((post, idx) => {
                  const sourcePath = selectedCategory === "All"
                    ? "/web-dev"
                    : `/web-dev?category=${encodeURIComponent(selectedCategory)}`;
                  const sourceLabel = selectedCategory === "All" ? "Web Dev" : selectedCategory;
