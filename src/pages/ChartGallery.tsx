...
const posts = [
  {
    title: "Global CO2 Emissions Map Dashboard",
    excerpt: "Interactive D3.js choropleth map plotting carbon emission variations globally with granular yearly filter curves.",
    date: "Feb 02, 2026",
  ...
  {
    title: "Stock Market Real-time Candlestick Chart",
    excerpt: "Recharts implementation with websocket subscription, streaming stock updates, and live moving averages overlay.",
    date: "Jan 12, 2026",
    readTime: "Live chart",
    category: "Recharts",
  ...
  {
    title: "Multi-view Healthcare Dashboard Layout",
    excerpt: "Executive Tableau dashboard template outlining wait-time indicators, occupancy analytics, and clinical KPIs.",
    date: "Dec 18, 2025",
    readTime: "Tableau layout",
    category: "Tableau",
  ...
  {
    title: "Climate Anomaly Spiral Diagram",
    excerpt: "R-based ggplot2 visualization detailing average temperature anomaly deviations using polar coordinates.",
    date: "Nov 05, 2025",
    readTime: "Static chart",
    category: "ggplot2",
...
const categories = ["All", "D3.js", "Recharts", "ggplot2", "Tableau"];

const categoryColors: Record<string, string> = {
  All: "bg-slate-900 text-white",
  "D3.js": "bg-violet-600 text-white",
  Recharts: "bg-emerald-500 text-white",
  ggplot2: "bg-orange-500 text-white",
  Tableau: "bg-sky-500 text-white",
};
...
const categoryInactive: Record<string, string> = {
  ...
  "D3.js": "bg-white text-violet-600 hover:bg-violet-50 dark:bg-slate-900 dark:text-violet-300 dark:hover:bg-slate-800",
  Recharts: "bg-white text-emerald-600 hover:bg-emerald-50 dark:bg-slate-900 dark:text-emerald-300 dark:hover:bg-slate-800",
  ggplot2: "bg-white text-orange-600 hover:bg-orange-50 dark:bg-slate-900 dark:text-orange-300 dark:hover:bg-slate-800",
  Tableau: "bg-white text-sky-600 hover:bg-sky-50 dark:bg-slate-900 dark:text-sky-300 dark:hover:bg-slate-800",
};
          ...
          <div className="relative container max-w-7xl mx-auto px-6 md:px-10">
            ...
            >
              ...
              <h1 className="blog-charcoal-heading text-4xl md:text-6xl font-bold tracking-tight text-[#1f1f1f] dark:text-[#1f1f1f] mb-5 leading-tight">
                Interactive data,<br />dashboards, and spirals.
              </h1>
              <p className="text-lg text-slate-500 dark:text-slate-300 max-w-xl leading-relaxed font-light">
                A curated showcase of statistical visualizations, reactive chart designs, and interface mockups.
              </p>
            </motion.div>
          </div>
        </section>
        ...
        <section className="py-16 md:py-20">
          <div className="container max-w-7xl mx-auto px-6 md:px-10">
                    ...
                    <div className="p-7 flex flex-col flex-1">
                      ...
                      <div className="flex items-center justify-between mt-6 pt-5 border-t border-slate-50 dark:border-slate-800">
                        ...
                        <span className={`inline-flex items-center gap-1 text-sm font-semibold transition-all duration-300 group-hover:gap-2 ${post.accentText} dark:text-violet-300`}>
                          View Visualization <ArrowRight className="h-3.5 w-3.5 transition-transform duration-300 group-hover:translate-x-0.5" />
                        </span>
                      </div>
                    </div>
                  </motion.article>
            ...
            {filtered.length === 0 && (
              ...
              >
                <p className="text-slate-400 dark:text-slate-500 text-lg mb-2">No charts found</p>
